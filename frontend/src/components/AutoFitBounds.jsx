// src/components/AutoFitBounds.jsx
import { useEffect, useMemo } from "react";
import { useMap } from "react-leaflet";
import L from "leaflet";

export default function AutoFitBounds({ points, onePointZoom = 14, maxZoomOnFit = 12 }) {
  const map = useMap();
  ...
  useEffect(() => {
    ...
    map.fitBounds(bounds, { padding: [50, 50], maxZoom: maxZoomOnFit, animate: true });
